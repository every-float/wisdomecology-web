...
layui.define(['layer'], function (exports) {
    ...
    admin.chooseLocation = function (param) {
        ...
        var layerWidth = param.layerWidth;  // 弹出框宽度
        ...
        if (layerWidth == undefined) layerWidth = "750px";
        ...
        var htmlStr = [
            ...
            '</div>'].join('');
        admin.open({
            id: 'ew-map-select', type: 1, title: dialogTitle, area: layerWidth, content: htmlStr,
