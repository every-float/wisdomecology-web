...
(function(window, factory) {
	if (typeof exports === 'object') { // 支持 CommonJS
		...
		layui.define(function(exports) {
			exports('croppers', factory());
		});
	} else {
		window.croppers = factory();
	}
})(this, function() {
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "" +
        ...
        "                    <button type=\"button\" class=\"layui-btn\" cropper-event=\"zoom\" data-option=\"0.1\" title=\"放大图片\">放大</button>\n" +
        "                    <button type=\"button\" class=\"layui-btn\" cropper-event=\"zoom\" data-option=\"-0.1\" title=\"缩小图片\">缩小</button>\n" +
        "                    <button type=\"button\" class=\"layui-btn\" cropper-event=\"reset\" title=\"重置图片\">重置</button>\n" +
        "                </div>\n" +
        "            </div>\n" +
        "        </div>\n" +
        "        <div class=\"layui-col-xs3\">\n" +
        "            <button class=\"layui-btn layui-btn-fluid\" cropper-event=\"confirmSave\" type=\"button\">确认保存</button>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "\n" +
        "</div>";
