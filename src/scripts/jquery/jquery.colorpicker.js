...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000">&nbsp;[<a href="javascript:void(0);" style="font-size:12px;" id="_cclose">关闭</a>]&nbsp;[<a href="javascript:void(0);" style="font-size:12px;" id="_creset">清除</a>]</td></tr></table></td></table>'
