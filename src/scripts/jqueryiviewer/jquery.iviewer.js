...
$.widget( "ui.iviewer", $.ui.mouse, {
    ...
    _create: function() {
        ...
        */
        ...
        this.img_object = new $.ui.iviewer.ImageObject(img, this.options.zoom_animation);
    ...
    **/
    ...
    {
    	layer.alert('1.打印前请先预览！页眉页面请自行设置！<br>2.如果图片过大，可左右拖动或放大图片预览打印效果！',
    			{icon: 0,
    ...
    **/
    createui: function()
    {
		...
		//var dd = $("<div>", { 'class': "iviewer_common_box"}).appendTo(this.container);
        var dd = $("<div>", { 'class': "iviewer_common_box"}).appendTo($('.layui-layer-phimg'));
        ...
        $("<div>", { 'class': "iviewer_rotate_right iviewer_common iviewer_button" })
                    ...
                    .appendTo(dd);
		//是否显示打印
		if(me.options.printer){
			$("<div>", { 'class': "iviewer_printer iviewer_common iviewer_button" })
			        .bind('mousedown touchstart',function(){me.printer(this); return false;})
			        .appendTo(dd);
		}
 ...
 */
$.ui.iviewer.ImageObject = function(img, do_anim) {
    this._img = img
