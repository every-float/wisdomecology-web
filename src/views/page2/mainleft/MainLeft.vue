<template>
    <div class="main-left">  <!-- 总9.54rem -->
        ...
        <block-container _title="大气环境质量变化趋势" height="3.54rem">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState('page2', ['shizhan', 'dataByDay', 'dataByMonth', 'leftBottomData'])
        },
        beforeMount () {
            this.handleData1();
        },
        async mounted () {
            ...
            this.currzb_1 = this.zblist[0]['name'];
        ...
        methods: {
            ...mapActions('page2', ['getXinlaoluR', 'getXinlaoluR_batch', 'getXinlaoluD_batch']),
            // 动态计算left_1的圆圈的高度
