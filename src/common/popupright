// 百度地图  -------->>>>>>>
document.write('<script type="text/javascript" src="https://api.map.baidu.com/api?v=3.0&ak=mE0GRctNh8W2180rEH5g95FXsEwmhhlp&s=1"></script>');
// document.write('<script type="text/javascript" src="https://api.map.baidu.com/getscript?v=3.0&ak=r40cEMmPvBW6FEjNpGjfVfpO0zyUTuu0&s=1"></script>');
...
document.write('<script type="text/javascript" src="https://api.map.baidu.com/library/DistanceTool/1.2/src/DistanceTool_min.js"></script>');

document.write('<link href="https://api.map.baidu.com/library/DrawingManager/1.4/src/DrawingManager_min.css" rel="stylesheet"  />');
document.write('<link href="../../css/bmap-common.css" rel="stylesheet" type="text/css">');
// 百度地图  <<<<<<<<<-------
